...
public class RpcSystemConfig {
    ...
    public static final String RPC_COMPILER_SPI_ATTR = "org.hotwheel.rpc1x.compiler.AccessAdaptive";
    public static final String RPC_ABILITY_DETAIL_SPI_ATTR = "org.hotwheel.rpc1x.core.AbilityDetail";
